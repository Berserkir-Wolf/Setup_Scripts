...
$Properties = @('DisplayName', 'UserPrincipalName', 'SignInActivity', 'Mail', 'AccountEnabled','CreatedDateTime')
...
# Get all users and their last login date from Active Directory including the name of the computer they signed in on and select relevant properties for display.
Import-Module ActiveDirectory
$AllADUsers = Get-ADUser -Filter * -Property DisplayName, UserPrincipalName, LastLogonDate, LastLogonComputer
$AllADUsers | Format-Table DisplayName, UserPrincipalName, LastLogonDate
